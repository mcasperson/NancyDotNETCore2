					...
					withCredentials([string(credentialsId: 'OctopusAPIKey', variable: 'APIKey')]) {
						timestamps {
							sh """
								...
								octo deploy-release --progress --project=Jenkins --deployto=Java --version=latest --server https://master.octopushq.com --deploymenttimeout 10:00:00 --deploymentchecksleepcycle 00:00:01 --apiKey ${APIKey}
							"""
						}
					}
				}
